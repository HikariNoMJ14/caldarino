	...
	<div id="main-content">
		...
		<?php if ( have_posts() ) :
				...
				while ( have_posts() ) :
					...
					wp_link_pages( array(
							'before'      => '<div class="page-links"><span class="page-links-title">' . __( 'Pages:', 'fgreen' ) . '</span>',
							'after'       => '</div>',
							'link_before' => '<span>',
							'link_after'  => '</span>',
						) );
					...
					the_post_navigation( array(
                        ...
                        'prev_text' => __( 'Previous Post: %title', 'fgreen' ),
                        'next_text' => __( 'Next Post: %title', 'fgreen' ),
                    ) );
